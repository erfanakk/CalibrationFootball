...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_kp", type=str, default="SV_kp",help="Path to the model for keypoint inference.")
    parser.add_argument("--weights_line", type=str, default="SV_lines",help="Path to the model for line projection.")
    ...
    parser.add_argument("--input_path", type=str, default=r"final_images\segment2_frame000238.jpg", help="Path to the input video or image file.")
    parser.add_argument("--input_type", type=str, default="image",
                        help="Type of input: 'video' or 'image'.")
    parser.add_argument("--save_path", type=str, default="segment2_frame000238.jpg", help="Path to save the processed video.")
